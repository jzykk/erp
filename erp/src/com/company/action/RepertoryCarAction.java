 ...
 * @category 库存商品车列表控制器
 */
@WebServlet("/repertorycar.action")
public class RepertoryCarAction extends HttpServlet {
	private static final long serialVersionUID = 1L;

	public RepertoryCarAction() {
		super();
	}
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (obj != null) {
			...
			List<RepertoryVo> list = repertoryService.findcar();
